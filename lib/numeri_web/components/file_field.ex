defmodule NumeriWeb.Components.FileField do
  @moduledoc """
  The `NumeriWeb.Components.FileField` module provides a versatile and customizable component
  ...
  import NumeriWeb.Components.Progress, only: [progress: 1]

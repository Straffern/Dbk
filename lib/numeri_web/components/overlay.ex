defmodule NumeriWeb.Components.Overlay do
  @moduledoc """
  The `NumeriWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `NumeriWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,

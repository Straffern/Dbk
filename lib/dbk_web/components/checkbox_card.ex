defmodule DbkWeb.Components.CheckboxCard do
  @moduledoc """
  The `DbkWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView

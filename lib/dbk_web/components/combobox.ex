defmodule DbkWeb.Components.Combobox do
  @moduledoc """
  The `DbkWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
  ...
  use Gettext, backend: DbkWeb.Gettext

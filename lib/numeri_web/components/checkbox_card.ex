defmodule NumeriWeb.Components.CheckboxCard do
  @moduledoc """
  The `NumeriWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView

defmodule NumeriWeb.Components.Spinner do
  @moduledoc """
  The `NumeriWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `NumeriWeb.Components.Spinner` module enables developers to provide

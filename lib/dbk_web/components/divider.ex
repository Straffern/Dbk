defmodule DbkWeb.Components.Divider do
  @moduledoc """
  The `DbkWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `DbkWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.

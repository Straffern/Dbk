defmodule DbkWeb.Components.FileField do
  @moduledoc """
  The `DbkWeb.Components.FileField` module provides a versatile and customizable component
  ...
  import DbkWeb.Components.Progress, only: [progress: 1]

defmodule NumeriWeb.Components.Banner do
  @moduledoc """
  NumeriWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.

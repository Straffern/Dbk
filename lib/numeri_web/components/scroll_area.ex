defmodule NumeriWeb.Components.ScrollArea do
  @moduledoc """
  The `NumeriWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView

defmodule Numeri.MixProject do
  use Mix.Project
  ...
  defp deps do
    [
      ...
      # {:ash_sqlite, "~> 0.2"},
      {:ash_sqlite, git: "https://github.com/ash-project/ash_sqlite", branch: "main"},
      {:ash_phoenix, "~> 2.0"},
  ...
  defp aliases do
    [
      ...
      "assets.deploy": [
        "tailwind numeri --minify",
        "esbuild numeri --minify",
        "phx.digest"
      ],

defmodule DbkWeb.Components.Menu do
  @moduledoc """
  The `DbkWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `DbkWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import DbkWeb.Components.Accordion, only: [accordion: 1]
  import DbkWeb.Components.Button, only: [button_link: 1]

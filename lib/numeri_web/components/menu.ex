defmodule NumeriWeb.Components.Menu do
  @moduledoc """
  The `NumeriWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `NumeriWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import NumeriWeb.Components.Accordion, only: [accordion: 1]
  import NumeriWeb.Components.Button, only: [button_link: 1]

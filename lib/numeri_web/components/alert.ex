defmodule NumeriWeb.Components.Alert do
  @moduledoc """
  NumeriWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts

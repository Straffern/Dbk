defmodule NumeriWeb.Components.Divider do
  @moduledoc """
  The `NumeriWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `NumeriWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.

defmodule NumeriWeb.Components.Combobox do
  @moduledoc """
  The `NumeriWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
  ...
  use Gettext, backend: NumeriWeb.Gettext

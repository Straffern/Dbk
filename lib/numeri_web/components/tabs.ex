defmodule NumeriWeb.Components.Tabs do
  @moduledoc """
  `NumeriWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import NumeriWeb.Components.Badge, only: [badge: 1]

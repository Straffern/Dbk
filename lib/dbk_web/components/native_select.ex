defmodule DbkWeb.Components.NativeSelect do
  @moduledoc """
  The `DbkWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `DbkWeb.Components.NativeSelect`
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DbkWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DbkWeb.Gettext, "errors", msg, opts)
    end
  end

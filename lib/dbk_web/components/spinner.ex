defmodule DbkWeb.Components.Spinner do
  @moduledoc """
  The `DbkWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `DbkWeb.Components.Spinner` module enables developers to provide

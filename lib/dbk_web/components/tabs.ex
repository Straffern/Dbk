defmodule DbkWeb.Components.Tabs do
  @moduledoc """
  `DbkWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import DbkWeb.Components.Badge, only: [badge: 1]

defmodule NumeriWeb.Components.NativeSelect do
  @moduledoc """
  The `NumeriWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `NumeriWeb.Components.NativeSelect`
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NumeriWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NumeriWeb.Gettext, "errors", msg, opts)
    end
  end
